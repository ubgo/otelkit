# otelkit documentation

| Guide | What it covers |
|---|---|
| [getting-started.md](./getting-started.md) | Zero to correlated telemetry in three lines. |
| [configuration.md](./configuration.md) | Option reference, the full `OTEL_*` env surface, and precedence. |
| [presets.md](./presets.md) | Vendor presets and exactly what each one encodes. |
