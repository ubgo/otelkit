module github.com/ubgo/otelkit/examples

go 1.25.0

require (
	github.com/ubgo/otelkit v0.0.0
	github.com/ubgo/otelkit/contrib/otelkit-grpc v0.0.0
...
replace github.com/ubgo/otelkit => ../

replace github.com/ubgo/otelkit/contrib/otelkit-grpc => ../contrib/otelkit-grpc
